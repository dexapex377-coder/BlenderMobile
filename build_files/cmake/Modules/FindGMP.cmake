...
#  GMPXX_INCLUDE_DIR
#  GMPXX_LIBRARY
SET(GMP_INCLUDE_DIRS ${LIB_DIR}/GMP/include/)
SET(GMP_INCLUDE_DIR  ${LIB_DIR}/GMP/include/)
SET(GMP_LIBRARIES
        ${LIB_DIR}/GMP/lib/libgmp.so
        ${LIB_DIR}/GMP/lib/libgmpxx.so
        c++_shared
        )
SET(GMP_ROOT_DIR ${LIB_DIR}/GMP/)
SET(GMP_FOUND ON)
