...
#  TBB_LIBRARY
SET(TBB_FOUND TRUE)
SET(TBB_INCLUDE_DIRS ${LIB_DIR}/Tbb/include/tbb-master/include)
SET(TBB_INCLUDE_DIR ${LIB_DIR}/Tbb/include/tbb-master/include)
SET(TBB_LIBRARIES
        ${LIB_DIR}/Tbb/lib/libtbb.so
        ${LIB_DIR}/Tbb/lib/libtbbmalloc.so
        ${LIB_DIR}/Tbb/lib/libtbbmalloc_proxy.so
        android
        )
