...
#  BLOSC_LIBRARY
#)
SET(BLOSC_INCLUDE_DIRS ${LIB_DIR}/blosc/include/)
SET(BLOSC_LIBRARIES ${LIB_DIR}/blosc/lib/libblosc.a)
SET(BLOSC_ROOT_DIR ${LIB_DIR}/blosc/include/)
SET(BLOSC_LIBRARY ${LIB_DIR}/blosc/lib/libblosc.a)
SET(BLOSC_FOUND ON)
