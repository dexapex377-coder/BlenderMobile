...
# Support externally-built datatoc for cross-compilation.
# Set -DDATATOC_EXECUTABLE=/path/to/datatoc to use a pre-built host binary.
function(_get_datatoc_executable _out_var)
  if(DEFINED DATATOC_EXECUTABLE AND NOT DATATOC_EXECUTABLE STREQUAL "")
    set(${_out_var} "${DATATOC_EXECUTABLE}" PARENT_SCOPE)
  else()
    set(${_out_var} "$<TARGET_FILE:datatoc>" PARENT_SCOPE)
  endif()
endfunction()
...
function(data_to_c
  ...
  _get_datatoc_executable(_datatoc_cmd)

  add_custom_command(
    OUTPUT ${file_to}
    COMMAND ${CMAKE_COMMAND} -E make_directory ${_file_to_path}
    COMMAND ${_datatoc_cmd} ${file_from} ${file_to}
    DEPENDS ${file_from} ${_datatoc_cmd})
...
function(data_to_c_simple
  ...
  add_custom_command(
    OUTPUT  ${_file_to}
    COMMAND ${CMAKE_COMMAND} -E make_directory ${_file_to_path}
    COMMAND ${_datatoc_cmd} ${_file_from} ${_file_to}
    DEPENDS ${_file_from} ${_datatoc_cmd})
...
function(data_to_c_simple_icons
  ...
  # Support externally-built datatoc_icon for cross-compilation.
  if(DEFINED DATATOC_ICON_EXECUTABLE AND NOT DATATOC_ICON_EXECUTABLE STREQUAL "")
    set(_datatoc_icon_cmd "${DATATOC_ICON_EXECUTABLE}")
  else()
    set(_datatoc_icon_cmd "$<TARGET_FILE:datatoc_icon>")
  endif()
  ...
  add_custom_command(
    ...
    COMMAND ${_datatoc_icon_cmd} ${_path_from_abs} ${_file_from}
    COMMAND ${_datatoc_cmd} ${_file_from} ${_file_to}
    DEPENDS
      ${_icon_files}
      ${_datatoc_icon_cmd}
