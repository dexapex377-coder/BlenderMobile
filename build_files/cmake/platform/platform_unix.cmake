...
SET(JPEG_LIBRARIES ${LIB_DIR}/JPEG/lib/libjpeg.a)
SET(JPEG_LIBRARY   ${LIB_DIR}/JPEG/lib/libjpeg.a)
SET(JPEG_INCLUDE_DIR ${LIB_DIR}/JPEG/include/LibJPEG/)
SET(ZLIB_LIBRARY ${LIB_DIR}/OpenCOLLADA/lib/libzlib.so)
set(PNG_PNG_INCLUDE_DIR ${LIB_DIR}/Png/include/libpng-1.6.40/)
set(PNG_LIBRARIES
        ${LIB_DIR}/Png/lib/libpng16.so
        ${ZLIB_LIBRARY}
        )
set(PNG ${LIB_DIR}/Png/include/libpng-1.6.40/)
set(PNG_INCLUDE_DIRS ${LIB_DIR}/Png/include/libpng-1.6.40/)
set(PNG_LIBPATH ${LIB_DIR}/Png/include/libpng-1.6.40/) # not cmake defined
SET(ZSTD_INCLUDE_DIRS ${LIB_DIR}/zstd/include/zstd/)
SET(ZSTD_LIBRARIES ${LIB_DIR}/zstd/lib/libzstd.so)
SET(ZSTD_LIBRARY   ${LIB_DIR}/zstd/lib/libzstd.so)
SET(ZSTD_ROOT_DIR ${LIB_DIR}/zstd/include/zstd/)
SET(ZSTD_FOUND ON)
SET(LibEpoxy_INCLUDE_DIRS ${LIB_DIR}/Epoxy/include/)
SET(LibEpoxy_LIBRARY ${LIB_DIR}/Epoxy/lib/libepoxy.a)
SET(LibEpoxy_LIBRARIES ${LIB_DIR}/Epoxy/lib/libepoxy.a)
SET(LibEpoxy_ROOT_DIR ${LIB_DIR}/Epoxy/include/)
...
#  find_package_wrapper(Freetype REQUIRED)
  ...
  SET(FREETYPE_LIBRARIES
          ${LIB_DIR}/Brotli/lib/libbrotlicommon.so
          ${LIB_DIR}/Brotli/lib/libbrotlidec.so
          ${LIB_DIR}/Brotli/lib/libbrotlienc.so
          ${LIB_DIR}/FreeType/lib/libfreetype.so
          )
...
SET(BOOST_INCLUDE_DIR ${LIB_DIR}/boost/boost_1_71_0/)
SET(Boost_INCLUDE_DIR ${LIB_DIR}/boost/boost_1_71_0/)
SET(BOOST_LIBRARIES
        ${LIB_DIR}/ICUC/lib/libicuc.so
        ${LIB_DIR}/BoostLocal/lib/libboostlocale.so
        ${LIB_DIR}/BoostPython/lib/libboostpython.so)
SET(BOOST_FOUND ON)
if(WITH_BOOST)
...
if(WITH_CYCLES AND WITH_CYCLES_PATH_GUIDING)
  SET(OPENPGL_LIBRARIES ${LIB_DIR}/Openpgl/lib/libopenpgl.so)
  SET(OPENPGL_INCLUDE_DIR ${LIB_DIR}/Openpgl/include/openpgl-0.7.0/openpgl/include/)
